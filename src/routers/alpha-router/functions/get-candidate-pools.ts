...
import { DAI_BASE, ITokenProvider, USDC_BASE, USDbC_BASE } from '../../../providers/token-provider';
...
const baseTokensByChain: { [chainId in ChainId]?: Token[] } = {
  ...
  [ChainId.BASE]: [USDbC_BASE, USDC_BASE, WRAPPED_NATIVE_CURRENCY[ChainId.BASE], DAI_BASE],
};
