import { ChainId, SupportedChainsType, Token, V2_SUBGRAPH_URL_MAP } from '@baseswapfi/sdk-core';
...
export class V2SubgraphProvider implements IV2SubgraphProvider {
  ...
  constructor(
    ...
    const subgraphUrl = V2_SUBGRAPH_URL_MAP[this.chainId as SupportedChainsType];
    if (!subgraphUrl) {
